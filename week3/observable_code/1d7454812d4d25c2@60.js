// https://observablehq.com/@berkeleyvis/how-to-submit-assignments@60
...
`To fork a notebook, click the "_fork_" button ([see more detailed instructions here](https://observablehq.com/@observablehq/fork-share-merge)) near the top of the page. Fork into either your own account or in the UC Berkeley group.

When you submit the link to the ISVC:

1. Click the three dots in the upper right.
2. Choose "Publish" menu item.
3. **Choose "unlisted" under heading Visibility**.
4. Click "Publish" button.

Do not publish your submission with visibility Public, which would make your submission viewable to the public (so others can\'t copy your work now or in future semesters!).
